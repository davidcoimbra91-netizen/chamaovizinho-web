      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr 280px', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            {/* Botão Configuração — bem visível em cima */}
            <Link href="/dashboard/faturacao/configuracao"
              style={{ display: 'flex', alignItems: 'center', gap: 10, background: 'linear-gradient(135deg,#C85A1A,#E07040)', borderRadius: 14, padding: '12px 14px', textDecoration: 'none', boxShadow: '0 4px 16px rgba(200,90,26,0.3)' }}>
              ...
              <div style={{ flex: 1 }}>
                <p style={{ fontSize: 12, fontWeight: 700, color: '#fff', marginBottom: 1 }}>⚙️ Configuração</p>
                <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.7)' }}>Logo, NIF, IBAN, IVA...</p>
              </div>
            ...
            {!billingProfile?.business_name && (
              <Link href="/dashboard/faturacao/configuracao" style={{ textDecoration: 'none' }}>
                <div style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 10, padding: '10px 12px', display: 'flex', gap: 8 }}>
                  ...
                  <p style={{ fontSize: 11, color: '#92400E', lineHeight: 1.4 }}>Completa a configuração antes de criar documentos</p>
                </div>
              </Link>
            )}
