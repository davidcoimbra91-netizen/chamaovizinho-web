          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ background: '#fff', border: '0.5px solid #EDE6DC', borderRadius: 14, padding: '16px 18px' }}>
              ...
              <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
                ...
                <Link href="/dashboard/faturacao/clientes" style={{ padding: '9px 14px', borderRadius: 9, border: '0.5px solid #EDE6DC', fontSize: 12, color: '#C85A1A', textDecoration: 'none', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4, background: '#fff' }}>
                  <Plus size={13} /> Novo
                </Link>
              </div>
              {selectedClient && (
                ...
                {lines.map((line, i) => (
                  <div key={i} style={{ display: 'grid', gridTemplateColumns: '1fr 60px 90px 80px 90px 32px', padding: '8px 12px', borderBottom: i < lines.length - 1 ? '0.5px solid #F0E8DC' : 'none', gap: 6, alignItems: 'center' }}>
                    <input value={line.description} onChange={e => updateLine(i, 'description', e.target.value)}
                      placeholder="Descrição..." style={{ padding: '6px 8px', borderRadius: 6, border: '0.5px solid #EDE6DC', fontSize: 12, outline: 'none', background: '#FAF7F2', width: '100%' }} />
                    <input type="number" value={line.quantity} onChange={e => updateLine(i, 'quantity', parseFloat(e.target.value) || 0)}
                      style={{ padding: '6px 8px', borderRadius: 6, border: '0.5px solid #EDE6DC', fontSize: 12, outline: 'none', background: '#FAF7F2', width: '100%' }} />
                    ...
                    <span style={{ fontSize: 12, fontWeight: 600, color: '#2C1A0E' }}>{(line.quantity * line.unit_price * (1 + line.vat_rate / 100)).toFixed(2)} €</span>
            ...
            <div style={{ background: '#fff', border: '0.5px solid #EDE6DC', borderRadius: 14, padding: '16px 18px' }}>
              ...
              <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={3} placeholder="Observações, condições de pagamento..."
                style={{ width: '100%', padding: '9px 12px', borderRadius: 9, border: '0.5px solid #EDE6DC', fontSize: 12, color: '#2C1A0E', background: '#FAF7F2', outline: 'none', resize: 'none', fontFamily: 'inherit' }} />
            </div>
          </div>
